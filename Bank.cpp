...
/* index of each account type type within our array
   this is an old-school way of declaring constants – you should be using:
     const int VARIABLE=0;
   as demonstrated below for the menu options.  These are here to show
   you #defines as you will likely come across them in many places,
   but you should avoid them yourself*/
#define CURRENT_ACCOUNT     0
#define SAVINGS_ACCOUNT     1
#define LOAN_ACCOUNT        2
#define NOOFACCOUNTS        3

const static int MENU_EXIT = 0;
const static int MENU_VIEW_SUMMARY = 1;
const static int MENU_DEPOSIT = 2;
const static int MENU_WITHDRAW = 3;
const static int MENU_SELECT_ACCOUNT = 4;

const static int FIRST_MENU_ITEM = MENU_EXIT;
const static int LAST_MENU_ITEM = MENU_SELECT_ACCOUNT;
...
int main()
{
 ...
 BankAccount* accounts[NOOFACCOUNTS] =
 {
   ...
   new SavingsAccount(201, "Savings", 400, 1.5, 100),
   new LoanAccount(301, "Loan", 5000, 2.5)
 };
